...
var _ = Describe("LoadWorker Controller", func() {
	Context("When reconciling a resource", func() {
		...
		loadworker := &loadtestv1.LoadWorker{}

		BeforeEach(func() {
			By("creating the custom resource for the Kind LoadWorker")
			err := k8sClient.Get(ctx, typeNamespacedName, loadworker)
		...
		AfterEach(func() {
			...
			By("Cleanup the specific resource instance LoadWorker")
